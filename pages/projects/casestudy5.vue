  ...
  <section>
    <div>
      ...
      <div>
        ...
        <p>Prior to completing the case study a suitable agile UX Research and UX Design methodology was developed to provide a effective solution to conduct project. Qualitative research methods would form the majority of the user research along with a small aspect of quantitative methods. Each research method will aim to provide the data to provide a solution to the problem statement</p>
        <p>The aspects of research to form the mixed methodology approached were as follows:</p>
        <ol>
          <li>User survey conducted directly on 10 Blackboard users</li>
    ...
    <div>
      ...
      <ul>
        ...
        <img src="~/assets/Question2.png" alt="Question 2 - Survey results displayed bar chart">
        <img src="~/assets/Question3.png" alt="Question 3 - Survey results displayed bar chart">
        <img src="~/assets/Question4.png" alt="Question 4 - Survey results displayed bar chart">
        <img src="~/assets/Question5.png" alt="Question 5 - Survey results displayed bar chart">
    ...
    <div>
      <h2>Test</h2>
      <ul>
        <li><h4>&#x2758; Cognitive Walk-through</h4></li>
        <p>The final phase of user testing was conducted in the form of a cognitive walk through. The cognitive walk-through was an effective solution to test- ing the proposed recommendations and enabled a way to imagine the users thoughts and action when interacting with a new interface for the first time. The three main goals in the second phase of user testing are; Identifying the users desired goals. Identifying the task to complete said goal. To document the experiences while completing the test.</p>
        <p>
    ...
    <div>
      ...
      <p>On completion of the UX case study a number of reflections were consid- ered of which would determine the success of the proposed features of which aimed to improve the user experience of the VLE. First the process to locate the weekly view student timetabe was improvement showing significant efficiency’s in time take to complete the task and click counts. Looking back to phase one testing there was a correlation between the higher scoring click counts and the verbal frustrations communicated. Upon using the newly pro- posed features there would be some expectation that because the click count was significantly reduced the negative dialogues around completing said task would also improve.</p>
