  ...
  <section>
    ...
    <div>
      ...
      <ul>
        ...
        <p>The ideas generated from the discovery phase were brought forward and bundled into a feature prioritisation illustration. Figures below sets out the proposed features and or concepts of which have been ideated and developed throughout conducting direct user research and wider research on engaging learning environments. The chart has two axis, low to high effort on the x-axis and high impact to low impact on the y-axis. Features where then mapped out upon both access to gauge which feature would essentially provide a high import with medium to minimal effort. The features of which fell into this category where outlined of which a final concept would be developed from these features.</p>
    ...
    <div>
      ...
      <ul>
        ...
        <p>The final phase of user testing was conducted in the form of a cognitive walk through. The cognitive walk-through was an effective solution to testing the proposed recommendations and enabled a way to imagine the users thoughts and action when interacting with a new interface for the first time. The three main goals in the second phase of user testing are; Identifying the users desired goals. Identifying the task to complete said goal. To document the experiences while completing the test.</p>
        <p>
