<template>
  <section>
    <div>
      <h1>Usability Testing Review &#x2758; Analysis</h1>
      <h4>&#x2758; The Client Brief</h4>
      <p>
        The brief was to conduct a usability review using various methods of usbility testing and analysis and data analysis, including performace and accessbility testing and analysis and to then produce a usability report that identified the shortfallls in usability and the proposed changes that Total Swimming could implement to improve the overal usability of the site.
      </p>
      <a href="https://www.dropbox.com/s/s03e6go2q61lics/usability-report.pdf?dl=0">View Usability Review</a>
      <a href="https://github.com/clarkenewsh/cis3160-usability-testing-improvements">GitHub</a>
    </div>
    <div><img src="~/assets/usability-thumb-1.png"></div>
    <div id="process">
      ...
      <div class="process-block">
        ...
        <div>
          ...
          <svg height="50" width="50" xmlns="http://www.w3.org/2000/svg" viewBox="4.9079999999999995 3.262 475.4839999999999 137.631"><linearGradient
            ...
            y1="192.352"
            y2="137.273"
          ><stop offset="0" stop-color="#ffd43b" /><stop offset="1" stop-color="#ffe873" /></linearGradient><linearGradient
            id="a"
            gradientTransform="matrix(.56254 0 0 .56797 -9.4 -5.305)"
            gradientUnits="userSpaceOnUse"
            x1="26.649"
            ...
            y1="20.604"
            y2="114.398"
          ><stop offset="0" stop-color="#5a9fd4" /><stop offset="1" stop-color="#306998" /></linearGradient><radialGradient
            id="c"
            cx="61.519"
            cy="132.286"
            gradientTransform="matrix(0 -.2964 1.43676 0 -128.544 150.52)"
            gradientUnits="userSpaceOnUse"
            r="29.037"
          ...
          <!-- <img class="stack-img" src="~/assets/axe-1.png">
          <img class="stack-img" src="~/assets/wave.png"> -->
        </div>
        <div>
          <h6>Data Analysis</h6>
